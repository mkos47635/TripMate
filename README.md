...
# 🙈 기능 엿보기(GIF)
## 회원가입 및 로그인
![join GIF](./TirpMate_server/resources/join.gif)

## 지역별, 카테고리별 관광지 검색
![search GIF](./TirpMate_server/resources/search.gif)

## 여행 일정 관리
![plan GIF](./TirpMate_server/resources/plan.gif)

## 여행 일정 공유
![share GIF](./TirpMate_server/resources/share.gif)

## 여행 일정 추천
![ai GIF](./TirpMate_server/resources/ai.gif)

## 게시판 보기 및 작성
![board GIF](./TirpMate_server/resources/board.gif)
